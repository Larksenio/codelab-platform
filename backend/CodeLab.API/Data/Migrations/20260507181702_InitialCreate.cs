        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Language = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Boilerplate = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StuckThresholdMinutes = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_AspNetUsers_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnalyticsCaches_Exercises_ExerciseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StudentAlias = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutionMs = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HintText = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HintRequests_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HintRequests_Submissions_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsCaches_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_InstructorId",
                table: "Exercises",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_Exercises_ShareToken",
                table: "Exercises",
                column: "ShareToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HintRequests_SessionId",
                table: "HintRequests",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_HintRequests_SubmissionId",
                table: "HintRequests",
                column: "SubmissionId");
